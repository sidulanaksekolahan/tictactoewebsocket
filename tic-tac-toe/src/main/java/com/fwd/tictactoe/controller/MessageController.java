...
import com.fwd.tictactoe.enumeration.GameState;
import com.fwd.tictactoe.manager.TicTacToeManager;
import com.fwd.tictactoe.model.TicTacToe;
import com.fwd.tictactoe.model.dto.JoinMessage;
import com.fwd.tictactoe.model.dto.PlayerMessage;
import com.fwd.tictactoe.model.dto.TicTacToeMessage;
...
public class MessageController {
    ...
    public Object joinGame(@Payload JoinMessage message, SimpMessageHeaderAccessor headerAccessor) {
        ...
        if (game == null) {
            ...
            errorMessage.setContent("Cannot enter the game. Maybe the game is full or an internal error occurred.");
            return errorMessage;
        }
